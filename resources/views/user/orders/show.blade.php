    ...
    <div class="mbui-page-header">
        ...
        <div class="flex items-center gap-3">
            @if ($order->isConfirmed())
                <a href="{{ route('user.orders.receipt', $order) }}" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">
