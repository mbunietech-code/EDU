<x-layouts.user :title="$research->title" :header="$research->title">
    ...
    <div class="mt-4 grid gap-6 lg:grid-cols-3">
        <div class="lg:col-span-2">
            ...
            @if ($startChapter)
                <div class="mt-6">
                    <x-mbui.btn-link :href="route('research.read', [$research, $startChapter])">
            ...
            <x-mbui.card class="p-5">
                ...
                <ol class="mt-3 space-y-3">
                    @foreach ($research->chapters as $i => $chapter)
                        <li>
                            <a href="{{ route('research.read', [$research, $chapter]) }}" class="text-sm font-semibold text-gray-900 hover:text-indigo-600">
                                {{ $chapter->title }}
                            </a>
