    ...
    <div class="min-h-full" x-data="{ sidebarOpen: false, consultationOpen: false, consultationSub: null }">
        <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-gray-900 transform transition-transform lg:translate-x-0"
            ...
            <nav class="mt-4 space-y-1 px-3">
                ...
                <x-user.sidebar-link :route="route('research.index')" :active="request()->routeIs('research.index') || request()->routeIs('research.category') || request()->routeIs('research.show') || request()->routeIs('research.read')" label="Research &amp; Consultancy">
