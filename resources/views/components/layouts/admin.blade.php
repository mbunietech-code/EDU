...
<head>
    ...
    <title>{{ $title ? $title . ' | Admin | ' . config('app.name', 'MBUNIETECH') : 'Admin | ' . config('app.name', 'MBUNIETECH') }}</title>
...
<body class="min-h-screen bg-gray-100" x-data="{ sidebarOpen: false }">
    <div class="min-h-full">
        <aside class="fixed inset-y-0 left-0 z-40 w-64 bg-gray-900 transform transition-transform lg:translate-x-0"
            ...
            <div class="absolute bottom-0 inset-x-0 border-t border-gray-800 p-4 space-y-2">
