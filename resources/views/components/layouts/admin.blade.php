    ...
    <div class="min-h-full">
        <aside class="fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-gray-900 transform transition-transform lg:translate-x-0"
            ...
            <nav class="mt-4 flex-1 space-y-1 overflow-y-auto px-3 pb-4">
                ...
                @can('research.view')
                <x-admin.sidebar-link :route="route('admin.research.index')" :active="request()->routeIs('admin.research.index') || request()->routeIs('admin.research.show') || request()->routeIs('admin.research.read') || request()->routeIs('admin.research.categories')" label="Research"
                    :badge="\App\Models\Research::pendingReviewCount()">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                </x-admin.sidebar-link>
                @endcan

                <x-admin.sidebar-link :route="route('library.index')" :active="request()->routeIs('library.*')" label="Research Library">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                </x-admin.sidebar-link>

                @if (auth()->user()?->canWriteResearch())
                <x-admin.sidebar-link :route="route('research.contributor.index')" :active="request()->routeIs('research.contributor.*')" label="My Research">
                ...
                @can('rooms.view')
                <x-admin.sidebar-link :route="route('admin.learning.live.index')" :active="request()->routeIs('admin.learning.live.*')" label="Live Sessions">
                ...
                <x-admin.sidebar-link :route="route('admin.team-chat.index')" :active="request()->routeIs('admin.team-chat.*')" label="Team Chat" :badge="auth()->user()->unreadTeamChatMessagesCount()">
                ...
                @can('database.access')
                <x-admin.sidebar-link :route="route('admin.optimization.index')" :active="request()->routeIs('admin.optimization.*')" label="AI Optimization">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z" />
                </x-admin.sidebar-link>
                @endcan

                @can('ai.access')
                <x-admin.sidebar-link :route="route('admin.ai-assistant.index')" :active="request()->routeIs('admin.ai-assistant.*')" label="AI Assistant">
