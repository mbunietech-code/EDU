...
@if ($items->isNotEmpty())
    <section aria-label="Published research" class="rs-marquee">
        <div class="mbui-container flex items-center justify-between gap-4 pb-3">
            <div>
        ...
        <div class="mbui-container pt-3 sm:hidden">
    ...
    <style>
        ...
        .rs-marquee__group { display:flex; gap:1rem; margin:0; padding:0 .5rem; list-style:none; }
        ...
        @media (prefers-reduced-motion: reduce) {
            ...
            .rs-marquee__viewport { overflow-x:auto; }
