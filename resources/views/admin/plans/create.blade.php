        ...
        <form method="POST" action="{{ route('admin.plans.store') }}" class="mbui-card p-6 space-y-5">
            ...
            <div>
                ...
                <div class="mt-1 grid gap-3 sm:grid-cols-2">
                    <label class="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-4">
                        <input type="radio" name="duration_type" value="days" class="mt-1 h-4 w-4 text-indigo-600" @checked(old('duration_type', 'days') === 'days')>
                        <span>
                    ...
                    <label class="flex cursor-pointer items-start gap-3 rounded-lg border border-gray-200 p-4">
                        <input type="radio" name="duration_type" value="lifetime" class="mt-1 h-4 w-4 text-indigo-600" @checked(old('duration_type') === 'lifetime')>
                        <span>
            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div id="daysField">
                    ...
                    <x-text-input id="duration_days" class="mbui-input mt-1" type="number" min="1" name="duration_days" :value="old('duration_days', 30)" />
