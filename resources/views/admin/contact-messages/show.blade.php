    ...
    <div class="mt-6 max-w-2xl">
        <x-mbui.card class="p-6">
            ...
            <div class="mt-6 flex items-center justify-between border-t border-gray-100 pt-4">
                ...
                <x-mbui.reasoned-action :action="route('admin.contact-messages.destroy', $contactMessage)" method="DELETE" label="Delete" prompt-text="Why are you deleting this message?" />
            </div>
        </x-mbui.card>
    </div>
