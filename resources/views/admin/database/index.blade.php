<x-layouts.admin title="Database" header="Database">
    ...
    <div class="mbui-page-header">
        ...
        <div class="flex items-center gap-3">
            <form method="POST" action="{{ route('admin.database.clear-caches') }}"
                  onsubmit="return confirm('Clear compiled views, config and route caches? Safe to run any time.');">
                @csrf
                <button type="submit" class="inline-flex items-center gap-2 rounded-lg bg-white px-4 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
