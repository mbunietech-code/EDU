...
<div x-data="chatThread({{ $conversation->id }}, {{ $isAdmin ? 'true' : 'false' }}, '{{ $sendUrl }}', '{{ $fetchUrl }}')" class="flex flex-col">
    <div x-ref="scroller" class="h-96 space-y-3 overflow-y-auto rounded-lg bg-gray-50 p-3">
